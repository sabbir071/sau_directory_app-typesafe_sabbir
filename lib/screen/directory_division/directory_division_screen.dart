...
import 'package:sau_directory/screen/directory_division/widget/card_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppbarInApp(
        appbarName: 'Directory & Division',
      ),
      body: Consumer<AppProvider>(builder: (context, provider, child) {
        return provider.directoryDivisionList == null
            ? const Center(
          ...
          child: AnimationLimiter(
            child: ListView.builder(
              ...
              itemCount: provider.directoryDivisionList!.length,
              itemBuilder: (context, position) {
                var directoryModel = provider.directoryDivisionList![position];
