...
import 'package:sau_directory/screen/student_hall/widget/card_widget.dart';
import 'package:sau_directory/widget/appbar_inapp.dart';
import 'package:sau_directory/widget/text/simple_text.dart';

class StudentHallScreen extends StatelessWidget {
  const StudentHallScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppbarInApp(
        appbarName: 'Student Hall',
      ),
      body: Consumer<AppProvider>(builder: (context, provider, child) {
        return provider.studentHallList == null
            ? const Center(
          ...
          child: AnimationLimiter(
            child: ListView.builder(
              ...
              itemCount: provider.studentHallList!.length,
              itemBuilder: (context, position) {
                var directoryModel = provider.studentHallList![position];
                        ...
                        onTap: () {
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                                    bool allMembersNull = directoryModel.title
                                        .every((titleModel) =>
