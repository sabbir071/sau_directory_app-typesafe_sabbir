...
import 'package:sau_directory/screen/offices/widget/card_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<AppProvider>(builder: (context, provider, child) {
        return provider.officesList == null
            ? const Center(
            ...
            : Padding(
                ...
                child: AnimationLimiter(
                  child: ListView.builder(
                    ...
                    itemCount: provider.officesList!.length,
                    itemBuilder: (context, position) {
                      var directoryModel = provider.officesList![position];
